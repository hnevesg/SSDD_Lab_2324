...
[["ice-prefix"]] module IceDrive {
  ...
  interface Directory {
    ...
    void linkFile(string fileName, string blobId) throws FileAlreadyExists, TemporaryUnavailable, Unauthorized;
    void unlinkFile(string fileName) throws FileNotFound, TemporaryUnavailable, Unauthorized;
  };
